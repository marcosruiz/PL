/* Generated By:JJTree&JavaCC: Do not edit this line. AnsiCJTreeTokenManager.java */
package ansicjtree;

/** Token Manager. */
public class AnsiCJTreeTokenManager implements AnsiCJTreeConstants
{
...
/** Constructor. */
public AnsiCJTreeTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public AnsiCJTreeTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
